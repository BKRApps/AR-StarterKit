//
//  PlaneDetection2ViewController.swift
//  AR-SwiftMeetup
//
...
class PlaneDetection2ViewController: UIViewController {
...
extension PlaneDetection2ViewController : ARSCNViewDelegate {
    /**
...
extension PlaneDetection2ViewController {
    static func getViewController() -> PlaneDetection2ViewController {
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        let viewController = storyboard.instantiateViewController(withIdentifier: "planeDetection2VC") as! PlaneDetection2ViewController
